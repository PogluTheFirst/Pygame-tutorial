...
#& This project focuses more on the making UI with pygame
#* 1. Creating menus
    #& A menu is just some text surface placed together
    #& I know, very useful information with nothing else here (i'm stupid)
